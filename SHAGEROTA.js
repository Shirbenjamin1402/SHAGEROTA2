...
lib.ssMetadata = [
		{name:"SHAGEROTA_atlas_", frames: [[3836,580,185,48],[3991,422,48,56],[3836,524,251,54],[2604,1893,271,191],[3836,0,209,209],[3836,422,153,100],[2877,1898,281,156],[3620,1868,323,165],[2002,899,960,590],[2002,0,1832,897],[2964,899,960,590],[3006,1491,327,405],[3335,1491,283,375],[3836,211,209,209],[3620,1491,283,375],[3335,1868,283,375],[2604,1491,400,400],[2002,1491,600,600],[0,0,2000,2000]]}
];
...
(lib.skyAnimationFinal = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1).to({regX:22.7,regY:11.9,scaleX:1,scaleY:1,rotation:-30,x:754.1,y:33.3},0).wait(1).to({x:747,y:50},0).wait(1).to({x:739.8,y:66.8},0).wait(1).to({x:732.7,y:83.5},0).wait(1).to({x:725.6,y:100.2},0).wait(1).to({x:718.5,y:117},0).wait(1).to({x:711.4,y:133.7},0).wait(1).to({x:704.3,y:150.4},0).wait(1).to({x:697.2,y:167.2},0).wait(1).to({x:690.1,y:183.9},0).wait(1).to({x:683,y:200.6},0).wait(1).to({x:675.8,y:217.4},0).wait(1).to({x:668.7,y:234.1},0).wait(1).to({x:661.6,y:250.8},0).wait(1).to({x:654.5,y:267.6},0).wait(1).to({x:647.4,y:284.3},0).wait(1).to({x:640.3,y:301},0).wait(1).to({x:633.2,y:317.8},0).wait(1).to({x:626.1,y:334.5},0).wait(1).to({x:619,y:351.2},0).wait(1).to({x:611.8,y:368},0).wait(1).to({x:604.7,y:384.7},0).wait(1).to({x:597.6,y:401.4},0).wait(1).to({x:590.5,y:418.2},0).wait(1).to({x:583.4,y:434.9},0).wait(1).to({x:576.3,y:451.6},0).wait(1).to({x:569.2,y:468.4},0).wait(1).to({x:562.1,y:485.1},0).wait(1).to({x:555,y:501.8},0).wait(1).to({x:547.9,y:518.6},0).wait(1).to({x:540.7,y:535.3},0).wait(1).to({x:533.6,y:552},0).wait(1).to({x:526.5,y:568.8},0).wait(1).to({x:519.4,y:585.5},0).wait(1).to({x:512.3,y:602.2},0).wait(1).to({x:505.2,y:619},0).wait(1).to({x:498.1,y:635.7},0).to({_off:true},1).wait(84).to({_off:false,regX:-0.1,regY:26.4,scaleX:1,scaleY:1,rotation:-29.9,x:500.6,y:9.5},0).wait(1).to({regX:22.7,regY:11.9,scaleX:1,scaleY:1,rotation:-31.6,x:495.8,y:-3.9},0).wait(1).to({rotation:-33.2,x:478.8,y:7.2},0).wait(1).to({rotation:-34.9,x:462.4,y:19},0).wait(1).to({rotation:-36.5,x:446.3,y:31.4},0).wait(1).to({rotation:-38.1,x:430.9,y:44.5},0).wait(1).to({rotation:-39.7,x:416,y:58.2},0).wait(1).to({rotation:-41.3,x:401.9,y:72.7},0).wait(1).to({rotation:-42.9,x:388.5,y:87.9},0).wait(1).to({rotation:-44.6,x:375.9,y:103.6},0).wait(1).to({rotation:-46.2,x:364.3,y:120.1},0).wait(1).to({rotation:-47.8,x:353.5,y:137.2},0).wait(1).to({rotation:-49.4,x:343.8,y:154.8},0).wait(1).to({rotation:-51,x:335.1,y:172.9},0).wait(1).to({rotation:-52.7,x:327.4,y:191.5},0).wait(1).to({rotation:-54.3,x:320.9,y:210.4},0).wait(1).to({rotation:-55.9,x:315.4,y:229.7},0).wait(1).to({rotation:-57.5,x:310.9,y:249.3},0).wait(1).to({rotation:-59.1,x:307.5,y:269},0).wait(1).to({rotation:-60.7,x:305.1,y:288.8},0).wait(1).to({rotation:-62.4,x:303.6,y:308.7},0).wait(1).to({rotation:-64,x:302.9,y:328.7},0).wait(1).to({rotation:-65.6,x:303.2,y:348.7},0).wait(1).to({rotation:-67.2,x:304.1,y:368.6},0).wait(1).to({rotation:-68.8,x:305.9,y:388.5},0).wait(1).to({rotation:-70.5,x:308.3,y:408.3},0).wait(1).to({rotation:-72.1,x:311.4,y:427.9},0).wait(1).to({rotation:-73.7,x:315.1,y:447.5},0).wait(1).to({rotation:-75.3,x:319.3,y:467},0).wait(1).to({rotation:-76.9,x:324.1,y:486.4},0).wait(1).to({rotation:-78.5,x:329.3,y:505.6},0).wait(1).to({rotation:-80.2,x:335,y:524.8},0).wait(1).to({rotation:-81.8,x:341.1,y:543.8},0).wait(1).to({rotation:-83.4,x:347.6,y:562.6},0).wait(1).to({rotation:-85,x:354.5,y:581.4},0).wait(1).to({rotation:-86.6,x:361.7,y:600},0).wait(1).to({rotation:-88.3,x:369.3,y:618.4},0).wait(1).to({rotation:-89.9,x:377.1,y:636.9},0).to({_off:true},1).wait(25).to({_off:false,regX:-1.5,regY:16.9,scaleX:1,scaleY:1,rotation:0,skewX:15,skewY:-165,x:571.8,y:36.2},0).wait(1).to({regX:22.7,regY:11.9,scaleX:1,scaleY:1,skewX:16.3,skewY:-163.7,x:568.5,y:33.6},0).wait(1).to({skewX:17.6,skewY:-162.4,x:587.1,y:42.6},0).wait(1).to({skewX:18.8,skewY:-161.2,x:605.4,y:52.3},0).wait(1).to({skewX:20.1,skewY:-159.9,x:623.3,y:62.5},0).wait(1).to({skewX:21.3,skewY:-158.7,x:641,y:73.3},0).wait(1).to({skewX:22.6,skewY:-157.4,x:658.1,y:84.8},0).wait(1).to({skewX:23.8,skewY:-156.2,x:674.8,y:96.9},0).wait(1).to({skewX:25.1,skewY:-154.9,x:691.1,y:109.6},0).wait(1).to({skewX:26.3,skewY:-153.7,x:706.9,y:122.9},0).wait(1).to({skewX:27.6,skewY:-152.4,x:722.1,y:136.8},0).wait(1).to({skewX:28.8,skewY:-151.2,x:736.8,y:151.2},0).wait(1).to({skewX:30.1,skewY:-149.9,x:750.9,y:166.3},0).wait(1).to({skewX:31.3,skewY:-148.7,x:764.4,y:181.8},0).wait(1).to({skewX:32.6,skewY:-147.4,x:777.3,y:197.9},0).wait(1).to({skewX:33.8,skewY:-146.2,x:789.5,y:214.4},0).wait(1).to({skewX:35.1,skewY:-144.9,x:801,y:231.4},0).wait(1).to({skewX:36.3,skewY:-143.7,x:812,y:248.8},0).wait(1).to({skewX:37.6,skewY:-142.4,x:822.3,y:266.6},0).wait(1).to({skewX:38.8,skewY:-141.2,x:831.9,y:284.8},0).wait(1).to({skewX:40.1,skewY:-139.9,x:840.8,y:303.2},0).wait(1).to({skewX:41.4,skewY:-138.6,x:849.2,y:321.9},0).wait(1).to({skewX:42.6,skewY:-137.4,x:856.9,y:341},0).wait(1).to({skewX:43.9,skewY:-136.1,x:863.9,y:360.2},0).wait(1).to({skewX:45.1,skewY:-134.9,x:870.5,y:379.7},0).wait(1).to({skewX:46.4,skewY:-133.6,x:876.4,y:399.3},0).wait(1).to({skewX:47.6,skewY:-132.4,x:881.7,y:419.1},0).wait(1).to({skewX:48.9,skewY:-131.1,x:886.6,y:439.1},0).wait(1).to({skewX:50.1,skewY:-129.9,x:890.9,y:459.1},0).wait(1).to({skewX:51.4,skewY:-128.6,x:894.7,y:479.2},0).wait(1).to({skewX:52.6,skewY:-127.4,x:898,y:499.5},0).wait(1).to({skewX:53.9,skewY:-126.1,x:900.9,y:519.8},0).wait(1).to({skewX:55.1,skewY:-124.9,x:903.4,y:540.1},0).wait(1).to({skewX:56.4,skewY:-123.6,x:905.4,y:560.6},0).wait(1).to({skewX:57.6,skewY:-122.4,x:906.9,y:580.9},0).wait(1).to({skewX:58.9,skewY:-121.1,x:908.2,y:601.4},0).wait(1).to({skewX:60.1,skewY:-119.9,x:909.1,y:621.9},0).wait(1).to({x:909,y:617.4},0).wait(1).to({y:612.9},0).wait(1).to({x:908.9,y:608.5},0).wait(1).to({y:604.1},0).wait(1).to({y:599.6},0).wait(1).to({x:908.8,y:595.1},0).wait(1).to({y:590.7},0).wait(1).to({y:586.2},0).wait(1).to({x:908.7,y:581.8},0).wait(1).to({y:577.3},0).wait(1).to({y:572.9},0).wait(1).to({x:908.6,y:568.4},0).wait(1).to({y:564},0).wait(1).to({x:908.5,y:559.5},0).wait(1).to({y:555},0).wait(1).to({y:550.6},0).wait(1).to({x:908.4,y:546.1},0).wait(1).to({y:541.7},0).wait(1).to({y:537.2},0).wait(1).to({x:908.3,y:532.8},0).wait(1).to({y:528.3},0).wait(1).to({y:523.9},0).wait(1).to({x:908.2,y:519.4},0).wait(1).to({y:514.9},0).wait(1).to({x:908.1,y:510.5},0).wait(1).to({y:506},0).wait(1).to({y:501.6},0).wait(1).to({x:908,y:497.1},0).wait(1).to({y:492.7},0).wait(1).to({y:488.2},0).wait(1).to({y:492.6},0).wait(1).to({y:497.1},0).wait(1).to({x:908.1,y:501.6},0).wait(1).to({y:506},0).wait(1).to({y:510.5},0).wait(1).to({x:908.2,y:514.9},0).wait(1).to({y:519.3},0).wait(1).to({x:908.3,y:523.9},0).wait(1).to({y:528.3},0).wait(1).to({y:532.8},0).wait(1).to({x:908.4,y:537.2},0).wait(1).to({y:541.7},0).wait(1).to({y:546.1},0).wait(1).to({x:908.5,y:550.6},0).wait(1).to({y:555},0).wait(1).to({y:559.5},0).wait(1).to({x:908.6,y:564},0).wait(1).to({y:568.4},0).wait(1).to({x:908.7,y:572.9},0).wait(1).to({y:577.3},0).wait(1).to({y:581.8},0).wait(1).to({x:908.8,y:586.2},0).wait(1).to({y:590.7},0).wait(1).to({y:595.1},0).wait(1).to({x:908.9,y:599.6},0).wait(1).to({y:604},0).wait(1).to({y:608.5},0).wait(1).to({x:909,y:612.9},0).wait(1).to({y:617.4},0).wait(1).to({x:909.1,y:621.9},0).wait(1));
...
(lib.SHAGEROTA = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		var backTimer;
		var EndSpace;
		//תשנה עזר של מספר השאלותההתחלתי
		var Qstamount = 0;
				...
				for (var i = 0; i < arrayQues[mychoice - 1][qnum].length; i++) {
					...
					if (i > 0) {
						...
						if ((arrayQues[mychoice - 1][qnum].length) - 1 == 4) {
							//פנייה למערך השאלות ==> מספר השאלה==>המסיח שנבחר==>התא הראשון, שבו קיים סוג האובייקט שרוצים לצור
						...
						if ((arrayQues[mychoice - 1][qnum][i][2]) == "P") {
					...
					if (i == 0) {
						...
						if ((arrayQues[mychoice - 1][qnum][i][1]) == "PG") {
		...
		function fly() {
			...
			//var newTimer1 = stage.getChildByName("newClock").getChildByName("myTimer");
			var WrongT = arrayQues[mychoice - 1][qnum][0][2];
			...
			if (getspaceSHIP.y <= 0) {
				...
				stage.removeChild(stage.getChildByName("newClock"));
				stage.removeChild(stage.getChildByName("MYmakashimGame"));
				//stage.removeChild(stage.getChildByName("picBoard"));
			...
			for (var i = 1; i < arrayQues[mychoice - 1][qnum].length; i++) {
				...
				if (getspaceSHIP.y < (myWhiteSpace.y + 90)) { //רק אם החללית בטווח פגיעה של החלליות הלבנות, נבדוק פגיעה
					myWhiteSpace.alpha = 0.5;
		
					if (intersect(getspaceSHIP, myWhiteSpace)) //מקרה של פגיעה במטרה
					{
						movestop = true;
						...
						if ((arrayQues[mychoice - 1][qnum][num][3]) == "true") {
							...
							//תשובה נכונה, זה אומר שהשחקן סיים את המשחק ולכן צריך להוריד את כפתור המשךולהעביר אותו למשוב המסכם
		...
		function nextQUESTyes() {
			...
			console.log(qnum, arrayQues[mychoice - 1].length);
			qnum = parseInt(Math.floor((Math.random() * arrayQues[mychoice - 1].length)));
		...
		function mainScreen() {
			//var myGrdaeText = stage.getChildByName("GrdaeText");
			//var mytimeEndText = stage.getChildByName("timeEndText");
			//var myMainScreen = stage.getChildByName("newMainScreen");
			//var myagaingame = stage.getChildByName("newPlayAgain");
		...
		function playAgain() {
			...
			//var myMainScreen = stage.getChildByName("newMainScreen");
			//var myagaingame = stage.getChildByName("newPlayAgain");
			//var halal = stage.getChildByName("newSky");
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/SHAGEROTA_atlas_.png?1518195729882", id:"SHAGEROTA_atlas_"},
		{src:"sounds/currectwav.mp3?1518195730078", id:"currectwav"},
		{src:"sounds/rocketfiringwav.mp3?1518195730078", id:"rocketfiringwav"},
		{src:"sounds/worngwav.mp3?1518195730078", id:"worngwav"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1518195730078", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1518195730078", id:"sdk/anwidget.js"},
		{src:"components/ui/src/combobox.js?1518195730078", id:"an.ComboBox"}
	],
	preloads: []
};
